...
## x-studio Pro 10.0.9000.31 (2021.5.x更新) `md5: a184cb0112442f4f5fa5bcfb51309e39`
- 【代码编辑】增强快速查找对话框搜索体验
- 【代码编辑】修复输出窗口`msvc++`编译信息行号定位问题
- 【UI编辑】修复当`显示节点边框`关闭时，打开工程闪退问题
- 【UI编辑】修复场景列表排重失败问题

## x-studio Pro 10.0.9000.29 (2021年4月14日更新) `md5: 419257a58e6e6b712161acc7fb8b796a`
- 【软件视觉】增强工具条和调用堆栈窗口4K显示器适配
- 【打开文件】如果.xsxproj工程文件在RecentFile列表，则直接以文本方式打开
- 【代码编辑】优化查找替换对话框按钮状态更新
- 【代码编辑】升级Scintilla至5.0.1
- 【代码编辑】升级boost.regex至1.76.0
