...
- 更新时间: 2022/05/??
- 更新内容: 
    1. 【代码编辑】 增强lua调试稳定性，修复在win11系统上调试宿主程序可能crash问题
    2. 【代码编辑】 修复调试lua时，lua异常窗口弹出可能导致悬浮变量窗口无法关闭问题
    3. 【代码编辑】 修复函数调用提示窗口无法显示问题
    4. 【代码编辑】升级`Scintilla`组件至`v5.2.2`
    5. 【代码编辑】升级`boost.regex`库至`v1.79.0`
    6. 【代码编辑】升级`luacheck`至`v0.26.1`
    7. 【代码编辑】升级`clang-format`至`v14.0.3`
    8. 【加密系统】增强加密系统功能增加`rc4`加密算法和`xxhash`摘要算法支持，详见文档
    9. 【UI编辑】快照节点保存图片为非ALPHA预乘
    
- MD5: ?

## x-studio 2022.1.4(Build 9900.15)
- 更新时间: 2022/02/21
- 更新内容: 
    1. 【代码编辑】 优化Lua调试异常处理
...
- MD5: 7ae389f1b54775b25222c7f5842bfb30

## x-studio 2022.1.3(Build 9900.13)
- 更新时间: 2022/01/20
- 更新内容: 
    1. 【代码编辑】 修复启动调试可能卡主问题
    2. 【UI编辑】 修复导入csb可能异常退出问题
    3. 【软件系统】 为解决复杂的微软运行库部署失败问题，将运行库替换为`msvcr14x`
    
- MD5: 7e4323de834e87836c4478b2fdd9c1e5

## x-studio 2022.1.2(Build 9900.11)
- 更新时间: 2022/01/06
- 更新内容: 
    1. 【代码编辑】 当Lua调试器后端检测到Lua代码文件名大小写不匹配时，显示异常提示对话框
    2. 【代码编辑】 修复`Ctrl+I`格式化文档会丢失最后一个字符问题
    3. 【代码编辑】 优化批量编码转换工具，转换前，始终尝试检测原文件编码
    4. 【软件系统】 安装新版本后，不再展示查看更新日志对话框
    
- MD5: abfe661d1795866e59a892d44975c192

## x-studio 2022.1.1(Build 9900.3)
- 更新时间: 2021.12.21
- 更新内容: 
    1. 【代码编辑】 修复升级安装后启动报错问题
- MD5: 960ea343cad326f8e0e749d43b3f14ea

## x-studio 2022.1.0(Build 9900.1)
- 更新时间: 2021.12.19
- 更新内容: 
    1. 【代码编辑】 Lua调试器条件断点支持
    ...
    28. 其他大量优化
- MD5: 1c03784b028761129d305aa7f775a386
